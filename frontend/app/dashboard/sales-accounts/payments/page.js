      ...
      <div className="space-y-2">
        ...
        <div>
          ...
          <p className="page-subtitle">
            Cash in (customers) and cash out (vendors) with balanced ledger
            enforcement.
          </p>
        </div>
      </div>
        ...
        <div className="of-card p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-2 text-xs">
            <input
              ...
              onChange={(e) =>
                setInForm((p) => ({ ...p, invoice_id: e.target.value }))
              }
            />
            <input
              className="of-input"
              ...
              onChange={(e) =>
                setInForm((p) => ({ ...p, customer_id: e.target.value }))
              }
            />
            ...
            <div className="grid grid-cols-2 gap-2">
              <input
                ...
                value={inForm.amount}
                onChange={(e) =>
                  setInForm((p) => ({ ...p, amount: e.target.value }))
                }
              />
              <input
                className="of-input"
                ...
                value={inForm.date}
                onChange={(e) =>
                  setInForm((p) => ({ ...p, date: e.target.value }))
                }
              />
            </div>
            <input
              ...
              value={inForm.mode}
              onChange={(e) =>
                setInForm((p) => ({ ...p, mode: e.target.value }))
              }
            />
          </div>
        ...
        <div className="of-card p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-2 text-xs">
            <input
              ...
              onChange={(e) =>
                setOutForm((p) => ({ ...p, vendor_id: e.target.value }))
              }
            />
            ...
            <input
              ...
              value={outForm.po_id}
              onChange={(e) =>
                setOutForm((p) => ({ ...p, po_id: e.target.value }))
              }
            />
            <div className="grid grid-cols-2 gap-2">
              <input
                ...
                onChange={(e) =>
                  setOutForm((p) => ({ ...p, amount: e.target.value }))
                }
              />
              <input
                className="of-input"
                ...
                value={outForm.date}
                onChange={(e) =>
                  setOutForm((p) => ({ ...p, date: e.target.value }))
                }
              />
            </div>
            <input
              ...
              value={outForm.mode}
              onChange={(e) =>
                setOutForm((p) => ({ ...p, mode: e.target.value }))
              }
            />
          </div>
          <div className="flex justify-end">
