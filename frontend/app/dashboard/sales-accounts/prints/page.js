...
const DOC_TYPES = [
  { id: 'invoice', label: 'Invoice', title: 'TAX INVOICE', numberLabel: 'Invoice #', refLabel: 'Delivery Ref' },
  { id: 'sales_order', label: 'Sales Order', title: 'SALES ORDER', numberLabel: 'SO #', refLabel: 'Quotation Ref' },
  { id: 'delivery', label: 'Delivery Challan', title: 'DELIVERY CHALLAN', numberLabel: 'DC #', refLabel: 'SO Ref' },
  { id: 'po', label: 'Purchase Order', title: 'PURCHASE ORDER', numberLabel: 'PO #', refLabel: 'Vendor Ref' }
];
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 max-w-4xl mx-auto print:w-[210mm] print:h-[297mm]">
        ...
        <div className="grid grid-cols-2 gap-4 text-xs mb-6">
          <div className="border border-slate-200 rounded-xl p-3">
            <div className="text-[11px] uppercase text-slate-500">Bill / Ship To</div>
            <div className="text-sm font-semibold text-slate-900">{toInfo.name}</div>
          ...
          <div className="border border-slate-200 rounded-xl p-3">
            <div className="text-[11px] uppercase text-slate-500">Ship From</div>
            <div className="text-sm font-semibold text-slate-900">{fromInfo.name}</div>
            <div className="text-slate-500 whitespace-pre-line">
              {fromInfo.address}
              {'\n'}
              {fromInfo.contact}
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 text-xs">
          <div className="flex-1 text-slate-600">
            <div className="font-semibold text-slate-900 mb-1">Terms & Notes</div>
        ...
        <div className="mt-8 text-xs text-slate-500 flex justify-between">
          <div>
            <div className="font-semibold text-slate-900">Authorized Signatory</div>
            <div className="text-slate-500">Matrix Office</div>
          </div>
          <div className="text-right">
            <div className="font-semibold text-slate-900">Thank you for your business</div>
            <div className="text-slate-500">Please quote {docMeta.numberLabel} on all correspondence.</div>
          </div>
        </div>
      </div>
    </motion.div>
