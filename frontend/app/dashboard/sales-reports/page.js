  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <motion.div
          whileHover={{ y: -2 }}
          className="bg-gradient-to-br from-indigo-500 to-purple-500 rounded-2xl text-white shadow-md p-4"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <motion.div
          whileHover={{ y: -2 }}
          className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 flex flex-col justify-between"
        >
