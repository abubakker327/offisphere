  ...
  async (req, res) => {
    try {
      ...
      if (error) {
        ...
        return res
          .status(500)
          .json({ message: 'Error exporting attendance' });
      }
  ...
  async (req, res) => {
    try {
      ...
      if (error) {
        ...
        return res
          .status(500)
          .json({ message: 'Error exporting timesheets' });
      }
  ...
  async (req, res) => {
    try {
      ...
      if (error) {
        ...
        return res
          .status(500)
          .json({ message: 'Error exporting payroll runs' });
      }
  ...
  async (req, res) => {
    try {
      ...
      if (error) {
        ...
        return res
          .status(500)
          .json({ message: 'Error exporting leaves' });
      }
